...
export class LoggingService extends Logger {
  ...
  logStripeApiCall(endpoint: string, method: string, duration: number, success: boolean, userId?: string) {
    this.winstonLogger.info('Stripe API Call', {
      endpoint,
      method,
      duration,
      success,
  ...
  logSubscriptionEvent(eventType: string, subscriptionId: string, userId?: string, details?: any) {
    this.winstonLogger.info('Subscription Event', {
      eventType,
      subscriptionId,
      userId,
      details,
