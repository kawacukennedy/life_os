...
export class LoggingService extends Logger {
  ...
  constructor() {
    ...
    this.winstonLogger = winston.createLogger({
      ...
      defaultMeta: { service: 'ai-inference-service' },
      transports: [
  ...
  logAiInference(operation: string, model: string, duration: number, success: boolean, userId?: string) {
    this.winstonLogger.info('AI Inference', {
      operation,
      model,
      duration,
      success,
  ...
  logVectorOperation(operation: string, collection: string, duration: number, success: boolean) {
    this.winstonLogger.info('Vector Operation', {
      operation,
      collection,
      duration,
      success,
